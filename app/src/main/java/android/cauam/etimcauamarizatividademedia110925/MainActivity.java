package android.cauam.etimcauamarizatividademedia110925;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalcuar.setOnClickListener(view->{
            validaCampos();
            calculaMedia();
    ...
    private void calculaMedia() {
        ...
        if(media >7){
            if(numeroFaltas < 20){
                ...
                resultado.setText("Excesso de faltas: " + numeroFaltas);
            }
        }
        else{
            resultado.setTextColor(Color.parseColor("#F44336"));
    ...
    private void initComponents() {
        ...
        btnCalcuar = findViewById(R.id.btnCalcular);
